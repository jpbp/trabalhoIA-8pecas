...
let start = criarEstadoInicial();
console.log(start);
document.querySelector("#um").innerHTML = start.vetor[0];
document.querySelector("#dois").innerHTML = start.vetor[1];
document.querySelector("#tres").innerHTML = start.vetor[2];
document.querySelector("#quatro").innerHTML = start.vetor[3];
document.querySelector("#cinco").innerHTML = start.vetor[4];
document.querySelector("#seis").innerHTML = start.vetor[5];
document.querySelector("#sete").innerHTML = start.vetor[6];
document.querySelector("#oito").innerHTML = start.vetor[7];
document.querySelector("#nove").innerHTML = start.vetor[8];
